...
import HeroVideo from "../assets/HeroVideo/video1.mp4"
...
const NewArithmoWorks = () => {
  return (
    <section id="howitworks" className="mt-40 min-h-[90vh]">
      <div>
        <h2 className="text-[30px] text-center text-[#0029FF] font-bold md:text-[40px]">
          How arithmo works
        </h2>
        <p className="max-w-[820px] font-medium m-auto p-2 text-left md:text-left">
          arithmo.ai extracts data. Devide on your Data and Process everything automatically.
          The advanced AI takes care of the rest for you so relax and let the work begin.
        </p>
      </div>
      <div className="max-w-8xl ml-auto">
        <article className="my-8 flex justify-around flex-col md:flex-row">
          ...
          <div className="bg-[#F1F3FA] lg:pr-[300px] p-8">
            ...
            <p className="text-[14px] font-medium leading-7 max-w-[242px]"> Watch the <a style={{textDecoration: 'underline'}} href="https://www.youtube.com/" target="_blank">Product Tutorial</a></p>
          </div>
        </article>
      </div>
    </section>
